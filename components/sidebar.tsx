...
import { Users, Settings, ChevronDown, LogOut, Folder, Archive, Globe, Orbit, Monitor } from 'lucide-react'
...
const adminNavItems: NavItem[] = [
  ...
  { title: 'Websites', href: '/websites', icon: Monitor, badge: 'New' },
  { title: 'Panorama', href: '/panoramas', icon: Globe, badge: 'New' },
  { title: 'Tours', href: '/tours', icon: Orbit, badge: 'New' },
